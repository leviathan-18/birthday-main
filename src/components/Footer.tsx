...
export default function Footer() {
  return (
    <footer className="w-full py-12 border-t border-glass bg-[#050505] flex flex-col items-center justify-center gap-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-48 h-12 md:w-96 md:h-24 bg-accent-glow/5 blur-[45px] md:blur-[100px] rounded-full pointer-events-none" />
