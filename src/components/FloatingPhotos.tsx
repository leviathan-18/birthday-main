  ...
  const photos = [
    {
      ...
      date: "2026",
      caption: "Reflection of names of mine and yours",
      opacity: p1Opacity,
      x: p1X,
      y: p1Y,
      scale: p1Scale,
    ...
    },
    {
      ...
      date: "2026",
      caption: "Rotate the phone clockwise to my love",
      opacity: p2Opacity,
      x: p2X,
      y: p2Y,
      scale: p2Scale,
    ...
    },
    {
      ...
      date: "2023",
      caption: "My lover is slowly getting faded from myself",
      opacity: p3Opacity,
      x: p3X,
      y: p3Y,
      scale: p3Scale,
    ...
    },
    {
      ...
      date: "2021",
      caption: "My love for her is not limited, it is for eternity and it has no ending",
      opacity: p4Opacity,
      x: p4X,
      y: p4Y,
      scale: p4Scale,
